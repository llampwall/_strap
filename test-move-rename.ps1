...
try {
  & "P:\software\_strap\build\strap.ps1" move --dest "P:\software\test" --dry-run
...
try {
  & "P:\software\_strap\build\strap.ps1" move testname --dry-run
  Write-Host "❌ Expected error but command succeeded" -ForegroundColor Red
} catch {
  Write-Host "✅ Correctly failed with error" -ForegroundColor Green
}
...
try {
  & "P:\software\_strap\build\strap.ps1" rename --to newname --dry-run
  Write-Host "❌ Expected error but command succeeded" -ForegroundColor Red
} catch {
  Write-Host "✅ Correctly failed with error" -ForegroundColor Green
}
...
try {
  & "P:\software\_strap\build\strap.ps1" rename oldname --dry-run
  Write-Host "❌ Expected error but command succeeded" -ForegroundColor Red
} catch {
  Write-Host "✅ Correctly failed with error" -ForegroundColor Green
}
...
try {
  & "P:\software\_strap\build\strap.ps1" move nonexistent --dest "P:\software\test" --dry-run
  Write-Host "❌ Expected error but command succeeded" -ForegroundColor Red
} catch {
...
try {
  & "P:\software\_strap\build\strap.ps1" rename nonexistent --to newname --dry-run
  Write-Host "❌ Expected error but command succeeded" -ForegroundColor Red
} catch {
  Write-Host "✅ Correctly failed with error (entry not found)" -ForegroundColor Green
}
